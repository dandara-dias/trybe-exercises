...
const teacher1 = new Teacher_1.default('Professor Um', new Date('1980/03/30'), 2000, subject1);
const teacher2 = new Teacher_1.default('Professor Dois', new Date('1982/04/21'), 2000, subject2);
const teacher3 = new Teacher_1.default('Professor Três', new Date('1986/01/29'), 2000, subject3);
